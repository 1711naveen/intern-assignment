                ...
                <div className="card" style={{ height: "412px", width: "340px" }}>
                    ...
                    <div className="card-body">
                        ...
                        <div className="box1">
                            ...
                            <a href='/'><img className='mt-2' src="material-symbols_delete-outline.png" alt="" /></a>
                            <a href=''><img className='mt-2' src="bxvideorecording.svg" alt="" /></a>
                            <a href=''><img className='mt-2' src="mdi_graph-box.svg" alt="" /></a>
                        </div>
